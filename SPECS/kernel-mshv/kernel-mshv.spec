...
mkdir -p drivers/misc/tarfs
cat > drivers/misc/tarfs/tarfs.c << 'EOF'
...
cat > drivers/misc/tarfs/Makefile << 'EOF'
ifneq ($(KERNELRELEASE),)
...
%changelog
* Tue Dec 10 2024 Mitch Zhu <mitchzhu@microsoft.com> - 5.15.157.mshv1-4
